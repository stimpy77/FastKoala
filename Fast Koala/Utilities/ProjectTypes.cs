...
namespace Wijits.FastKoala.Utilities
{
    ...
    public static class ProjectTypes
    {
        ...
        public static Guid AspNetMvc20 = new Guid("F85E285D-A4E0-4152-9332-AB1D724D3325");
        public static Guid AspNetMvc30 = new Guid("E53F8FEA-EAE0-44A6-8774-FFD645390401");
        public static Guid AspNetMvc40 = new Guid("E3E379DF-F4C6-4180-9B81-6769533ABE47");
        public static Guid CSharp = new Guid("FAE04EC0-301F-11D3-BF4B-00C04F79EFBC");
        public static Guid CPlusPlus = new Guid("8BC9CEB8-8B4A-11D0-8D11-00A0C91BC942");
        public static Guid Database = new Guid("A9ACE9BB-CECE-4E62-9AA4-C7E7C5BD2124");
        public static Guid DatabaseOther = new Guid("4F174C21-8C12-11D0-8340-0000F80270F8");
        ...
        public static Guid Dynamics2012AXCSharpInAot = new Guid("BF6F8E12-879D-49E7-ADF0-5503146B24B8");
        ...
        public static Guid MonoForAndroid = new Guid("EFBA0AD7-5A72-4C68-AF49-83D382785DCF");
        public static Guid MonoTouch = new Guid("6BC8ED88-2882-458C-8E55-DFD12B67127B");
        public static Guid MonoTouchBinding = new Guid("F5B4F3BC-B597-4E2B-B552-EF5D8A32436F");
        public static Guid PortableClassLibrary = new Guid("786C830F-07A1-408B-BD7F-6EE04809D6DB");
        ...
        public static Guid VisualCPlusPlus = new Guid("8BC9CEB8-8B4A-11D0-8D11-00A0C91BC942");
        public static Guid WindowsCommunicationFoundation = new Guid("3D9AD99F-2412-4246-B90B-4EAA41C64699");
        public static Guid WindowsPhone8xBlankOrHubOrWebviewApp = new Guid("76F1466A-8B6D-4E39-A767-685A06062A39");
        public static Guid WindowsPhone8xAppCSharp = new Guid("C089C8C0-30E0-4E22-80C0-CE093F111A43");
        public static Guid WindowsPhone8xAppVB = new Guid("DB03555F-0C8B-43BE-9FF9-57896B3C5E56");
        public static Guid WindowsPresentationFoundation = new Guid("60DC8134-EBA5-43B8-BCC9-BB4BC16C2548");
        public static Guid WindowsStoreAppOrComponent = new Guid("BC8A1FFA-BEE3-4634-8014-F334798102B3");
        ...
        public static Guid WorkflowFoundation = new Guid("32F31D43-81CC-4C15-9DE6-3FC5453562B6");
        public static Guid XamarinAndroid = new Guid("EFBA0AD7-5A72-4C68-AF49-83D382785DCF");
        public static Guid XamariniOS = new Guid("6BC8ED88-2882-458C-8E55-DFD12B67127B");
